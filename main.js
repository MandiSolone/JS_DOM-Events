...
const nodeOne = document.getElementById("node1");
...
parent.insertBefore(a, newParagraph); 
...
function show (){
    //adding 2 divs, and 3 elements including a btn to the HTML
    ...
    // adding text content to the modalCard elements
    h2.textContent = "Modal Header";  
    p.textContent = "Modal  content"; 
    closeBtn.textContent = "Close"; 

    // add an event listener to the closeBtn that removes the modalContainer from the body
    ...
    // applying CSS styling to the modalCard & Modal
    modalCard.classList.add("modal-card");
    modalContainer.id = "modal"; 

    // attaching modalCard to modalContainer and then modalContainer to the body of the HTML 
    modalContainer.appendChild(modalCard); 
    document.body.appendChild(modalContainer); 
}

// when btn his clicked the Modal (above) apperas 
